...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'Remove Extra Spaces — Kraviona Tools',
    description:
    ...
    alternates: { canonical: absoluteUrl('/tools/remove-extra-spaces') },
    openGraph: {
      title: 'Remove Extra Spaces — Kraviona Tools',
      description: 'Strip extra spaces, double spaces, and leading/trailing whitespace from any text.',
      url: absoluteUrl('/tools/remove-extra-spaces'),
    },
  };
}

...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'Lorem Ipsum Generator — Kraviona Tools',
    description:
    ...
    alternates: { canonical: absoluteUrl('/tools/lorem-ipsum') },
    openGraph: {
      title: 'Lorem Ipsum Generator — Kraviona Tools',
      description: 'Generate Lorem Ipsum filler text by paragraphs, sentences, or words.',
      url: absoluteUrl('/tools/lorem-ipsum'),
    },
  };
}
